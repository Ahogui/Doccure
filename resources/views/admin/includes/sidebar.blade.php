	...
	<div class="sidebar-inner slimscroll">
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul>
				...
				@endcan
                <li class="submenu">
					<a href="#"><i class="fe fe-activity"></i> <span> Facturation</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
                ...
                <li class="submenu">
					<a href="#"><i class="fe fe-activity"></i> <span> Gestion de compte</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
                ...
                @can('view-service')
				<li class="submenu">
					<a href="#"><i class="fe fe-user"></i> <span> Département</span> <span class="menu-arrow"></span></a>
					<ul style="display: none;">
